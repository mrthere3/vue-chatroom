<template>
  ...
  <div class="flex h-screen w-full items-center justify-center bg-gray-900 bg-cover bg-no-repeat" style="
    ...
    ">
    <div class="rounded-xl bg-gray-800 bg-opacity-50 px-24 py-24 shadow-lg backdrop-blur-md max-sm:px-28">
      <div class="text-white px-16 py-20">
        <div class="mb-19 flex flex-col items-center">
          <img src="https://www.logo.wine/a/logo/Instagram/Instagram-Glyph-Color-Logo.wine.svg" width="150" alt=""
            srcset="" />
          <h1 class="mb-4 text-4xl">Instagram</h1>
          <span class="mb-6 text-gray-300 text-2xl">Enter Login Details</span>
        </div>
        <form action="#" class="mb-12">
          ...
          <div class="mt-8 flex justify-center text-xl text-black">
