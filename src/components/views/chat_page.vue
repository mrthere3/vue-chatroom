<template>
  <div class="w-full shadow-lg mx-auto rounded-lg">
    <!-- headaer -->
    <!-- end header -->
    <!-- Chatting -->
    <div class="flex flex-row justify-between bg-white">
      ...
      <div class="flex flex-col w-1/5 h-full border-r-2">
        ...
        >
          ...
          <div
            class="w-3/5 text-2xl font-serif font-medium ml-2 text-center hover:bg-red-50"
            @mouseover="showfulltext(index)"
          >
            <el-tooltip
              :disabled="isTooltipVisible != index"
              class="box-item"
              :content="item"
              placement="bottom"
            >
      ...
      <!-- end chat list -->
      <!-- message -->
      <div class="w-full h-screen px-5 flex flex-col justify-between text-2xl">
        <div
          class="flex flex-col mt-5 overflow-y-auto overscroll-contain h-6/10"
          ref="chatroom"
        >
        ...
        <div class="py-4">
          <textarea
            ...
            class="w-full h-60 bg-gray-300 py-5 px-3 rounded-xl"
